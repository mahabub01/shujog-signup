<div>
    ...
    <div>
        ...
        <div class="mb-3 row form-row">
            <label for="inputSubModuleId" class="col-sm-4 col-form-label text-end">Components<span style="color: red">*</span></label>
            <div class="col-sm-8">
                <select id="module_id_select1" name="sub_module_id" class="form-control gray-border form-select" aria-label="Default select example" id="inputSubModuleId">
                    <option value="">Choose</option>
