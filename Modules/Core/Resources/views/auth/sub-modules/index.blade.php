...
@component('core::inc.filter')
    @slot('filter_route')
    {{Form::open(['route'=>['core.components.filter'],'method'=>'GET'])}}
    @endslot
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse driction" id="navbarSupportedContent">
                    <div class="row">
                        <p>Components</p>
                        <h5>All Components <i class="fas fa-caret-down"></i> <span class="pin"><i class="fas fa-thumbtack"></i></span></h5>
                    </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{route('core.components.create')}}">New</a>
                      </li>
                      <li class="nav-item">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-color">
                                        @if($data->upload_icon != "")
                                            <img src="{{asset('uploads/submodule-icon/'.$data->upload_icon)}}" alt="Module Icon" height="30px;">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <li>
                                                @if($data->is_active == 1)
                                                    <a href="{{url('admins/settings/components/status/'.$data->id)}}" class="text-decoration-none"><button type="button" class="btn-view dropdown-item"><i class="fa fa-eye"></i> Active</button></a>
                                                @else
                                                    <a href="{{url('admins/settings/components/status/'.$data->id)}}" class="text-decoration-none"><button type="button" class="btn-view dropdown-item"><i class="fas fa-eye-slash"></i> In-active</button></a>
                                                @endif
                                            </li>


                                            <li><a class="dropdown-item" href="{{url('admins/settings/components/'.$data->id.'/edit')}}"><i class="fa fa-edit"></i> Edit</a></li>
                                            ...
                                            <li><a class="text-decoration-none"><button type="submit" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#bt5DeleteModal"
                                                data-url="{{url('admins/settings/components/'.$data->id)}}"
