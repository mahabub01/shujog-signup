...
{{Form::open(['route'=>['core.users.changePermission',$user_id],'method'=>'POST'])}}
   ...
   <div class="content-header sticky-top">
        <div class="container-fluid">
           <h2 class="me-auto mb-2 mb-lg-0">Update Permission</h2>
            <div class="d-flex">
                <a href="{{ route('core.users.index') }}"><button class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</button></a>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-5">
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" id="inputName" value="{{$role_name}}">
                            </div>
                        </div>
                    </div>
                </div>
