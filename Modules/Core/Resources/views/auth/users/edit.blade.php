...
{{Form::open(['route'=>['core.users.update',$data->id],'method'=>'PUT'])}}
@include('core::inc.toaster-message')

    <!--start content  section-->
   <div class="content-header sticky-top">
        <div class="container-fluid">
           <h2 class="me-auto mb-2 mb-lg-0">Edit Users</h2>
            <div class="d-flex">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-5 m-auto">
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" value="{{$data->name}}" name="name" placeholder="Write your name" class="form-control" id="inputTitle">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" value="{{$data->email}}" name="email" placeholder="Write your email" class="form-control" id="inputTitle">
                            </div>
                        </div>
                        <div class="mb-3 row form-row">
