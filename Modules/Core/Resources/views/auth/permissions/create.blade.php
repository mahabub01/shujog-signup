...
{{Form::open(['route'=>['core.permissions.store'],'method'=>'POST','files'=>true])}}

    <!--start content  section-->
   <div class="content-header sticky-top">
        <div class="container-fluid">
           <h2 class="me-auto mb-2 mb-lg-0">Create Permisssion</h2>
            <div class="d-flex">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-5">
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" name="name" placeholder="Write your Permission Name" class="form-control" id="inputTitle">
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" name="professional_name" placeholder="Write your Professional Name" class="form-control" id="inputAction">
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                                <input type="radio"  name="is_view_with_component" value="1"> Yes
                                <input type="radio"  name="is_view_with_component" value="0" checked> No
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="route_url" placeholder="Write your Route Url" class="form-control" id="inputRouteUrl">
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="action" placeholder="Write your Action name" class="form-control" id="inputRouteUrl">
