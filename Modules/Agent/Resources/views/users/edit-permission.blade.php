...
{{Form::open(['route'=>['agent.user.editpremission',[$mod,$user_id]],'method'=>'POST'])}}
   ...
   <div class="content-header sticky-top">
        <div class="container-fluid">
           <h2 class="me-auto mb-2 mb-lg-0">Update Permission</h2>
            <div class="d-flex">
                <a href="{{ url('agent/users') }}"><button type="button" class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</button></a>
