...
{{Form::open(['route'=>['agent.pmg-projects.store',$module],'method'=>'POST','files'=>true])}}

    <!--start content  section-->
   <div class="content-header sticky-top">
        <div class="container-fluid">
           <h2 class="me-auto mb-2 mb-lg-0">Create Projects</h2>
            <div class="d-flex">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-5">
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="date" name="extention_time"  class="form-control" id="extention_time">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="number" name="customer_served"  class="form-control" id="customer_served">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="description"  class="form-control" id="description_level"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 row form-row">
                            <label for="inputTitle" class="col-sm-4 col-form-label text-end">Sur Name<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                            <input type="text" name="sur_name" placeholder="Write Sur Name" class="form-control" id="inputTitle">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="number" name="wmm_target"  class="form-control" id="wmm_target">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-row">
                            ...
                            <div class="col-sm-8">
                            <input type="number" name="sales_target"  class="form-control" id="sales_target">
                            </div>
                        </div>
