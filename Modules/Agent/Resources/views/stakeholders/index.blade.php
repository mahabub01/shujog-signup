                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                          ...
                          @auth_access('agent-mem-cons-stkholder-single-export')
                          <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex">
                            ...
                            <div class="d-flex" style="margin-bottom: 20px;">
                                {{-- <button class="icon_btn" type="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"><i class="fas fa-cog"></i></button>
                                ...
                                <a href="{{ url($module.'/stakeholders/?role='.$first_active_tab->role_id) }}"><button type="button" class="icon_btn"><i class="fas fa-redo"></i></button></a>
                                    ...
                                    <td class="col-serial table-body-index">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu table-dropdown">
                                              ...
                                              @auth_access('agent-mem-cons-stkholder-cmnt-view')
                                              <li><a href="{{ url($module.'/stakeholders/consultant-comments/'.$user->id) }}" class="dropdown-item"><i class="far fa-comments"></i> Comment</a></li>
                                              @end_auth_access

                                              @auth_access('agent-mem-cons-stkholder-eval-view')
                                              <li><a href="{{ url($module.'/stakeholders/evaluation/'.$user->id) }}" class="dropdown-item"><i class="fas fa-question-circle"></i> Evaluation</a></li>
                                              @end_auth_access

                                              @auth_access('agent-mem-cons-stkholder-edit')
                                              <li><a href="{{ url($module.'/stakeholders/'.$user->id.'/edit') }}" class="dropdown-item"><i class="fas fa-user-cog"></i> Update Stakeholder</a></li>
                                              @end_auth_access
                                            </ul>
                                          </div>
                                    </td>
