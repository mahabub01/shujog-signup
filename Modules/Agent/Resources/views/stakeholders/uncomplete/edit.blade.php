...
<div class="content-bg-section">
    <div class="content-section">
        <div class="container-fluid margin-top-20">
            ...
            {{ Form::open(['route'=>['agent.incomplete-signup.update',$module,$id],'method'=>'PUT','files'=>true]) }}
                        ...
                        <div class="col-md-9">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="role_id" class="form-control js-example-basic-single" @if($user->spatie_role_id != "") readonly @endif>
                            ...
                            <tr>
                                <th>References<span style="color:red">*</span></th>
                                <td>
                                    <select name="signup_reference_id" class="form-control js-example-basic-single">
                                         <option value="" selected>Choose</option>
                                        @foreach ($references as $reference)
                                            @if($user->signup_reference_id == $reference->id)
