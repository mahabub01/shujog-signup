...
@section('title','Reject Stakeholders Comments')
        ...
        <div class="content-section">
            <div class="container-fluid margin-top-20">
                ...
                <div class="card">
                    ...
                    {{ Form::open(['route'=>['agent.trainer-reject-stk-comment',$module,$user_id],'method'=>'POST']) }}
                    <!--start row -->
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control js-example-basic-single" name="status">
                                    ...
                                    @foreach (getConsultantStatus(true,[1,3,4]) as $k => $status)
