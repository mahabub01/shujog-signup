...
@component('core::inc.filter')
    @slot('filter_route')
    {{Form::open(['route'=>['agent.nmg-stkholder.filter',$module],'method'=>'GET'])}}
    @endslot
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="col-md-3">
            ...
            <select class="form-control js-example-basic-multiple full-width" name="status">
                <option value="">Choose</option>
                @foreach(getNetworkMngStatus(true,['7']) as $k => $sts)
                    @if($status == $k)
        ...
        <div class="container-fluid  table-design-container">
            <ul class="nav nav-tabs">
                @foreach ($selectRoles as $sel_roles)
                  <li class="nav-item">
                    <a class="nav-link @if($first_active_tab->id == $sel_roles->id) active @endif" href="{{ url($module.'/nmg-stkholders/?role='.$sel_roles->role_id) }}" style="font-weight: bolder;color:#495057;font-size:14px">{{ $sel_roles->role->name }}</a>
                  </li>
                @endforeach
            </ul>
            ...
            <div class="card" style="border-radius: 0px 5px 5px 5px;border-top:none">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                          ...
                          @auth_access('agent-nmg-stkholder-single-export')
                          <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex">
                            ...
                            <div class="d-flex" style="margin-bottom: 20px;">
                                ...
                                <a href="{{ url($module.'/nmg-stkholders/?role='.$first_active_tab->role_id) }}"><button type="button" class="icon_btn"><i class="fas fa-redo"></i></button></a>
                                @auth_access('agent-nmg-stkholder-filter')
                ...
                {{Form::open(['route'=>['agent.nmg-stkholder.export',$module],'method'=>'POST','id'=>'exportForm'])}}
                                    ...
                                    <td class="col-serial table-body-index">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu table-dropdown">
                                              @auth_access('agent-nmg-stkholder-details')
                                              <li><a href="{{ url($module.'/nmg-stkholders/'.$user->id) }}" class="dropdown-item"><i class="fas fa-eye"></i> Details</a></li>
                                              @end_auth_access

                                              @auth_access('agent-nmg-stkholder-cmnt-view')
                                              <li><a href="{{ url($module.'/nmg-stkholders/comments/'.$user->id) }}" class="dropdown-item"><i class="far fa-comments"></i> Comment</a></li>
                                              @end_auth_access
