...
@section('title','Rejected Stakeholders Details')
@section('content')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card" style="margin-top: 10px;">
                                                ...
                                                <div class="card-header">
                                                    <p>NID Front <a href="{{ $thardpary_info['self_nid_card_front_image'] }}" target="_blank" style="float: right;"><i class="fas fa-images"></i> View</a></p>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card" style="margin-top: 10px;">
                                                ...
                                                <div class="card-header">
                                                    <p>NID Front <a href="{{ $thardpary_info['self_nid_card_back_image'] }}" target="_blank" style="float: right"><i class="fas fa-images"></i> View</a></p>
                                                </div>
