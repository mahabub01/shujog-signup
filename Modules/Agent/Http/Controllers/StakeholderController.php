...
class StakeholderController extends Controller
{
    ...
    public function index($module,Request $request)
    {
        ...
        return view("agent::stakeholders.index",[
    ...
    public function filter(Request $request,$module)
    {
        ...
        if(isset($request->role)){
            ...
            $stakeholders_query = User::with(['stakeholder','stakeholderEvaluation','stakeholderCommnet','signupReference','stakeholderCommnetForTrainer','stakeholderCommnetForDeployer','stakeholderCommnetForNmanager','assignProject'=>function($q){
                $q->select('stakeholder_id','project_id');
            },'assignProject.project'])->where(['spatie_role_id'=>$request->role]);
            ...
            $stakeholders_query = User::with(['stakeholder','stakeholderEvaluation','stakeholderCommnet','signupReference','stakeholderCommnetForTrainer','stakeholderCommnetForDeployer','stakeholderCommnetForNmanager','assignProject'=>function($q){
                $q->select('stakeholder_id','project_id');
            },'assignProject.project'])->where(['spatie_role_id'=>$first_active_tab->role_id]);
    ...
    public function allExport(Request $request,$module){
        ...
        return Excel::download(new AllStakeholderExport($request), 'all-stackholders.xlsx');
    }
    ...
    public function selectable(Request $request){
        ...
        return Excel::download(new SelectableExport($request), time().'_stakeholders.xlsx');
    ...
    *********************************/
        ...
        return view("agent::stakeholders.details",[
            'user'=>$user,
            'module'=>$module,
    ...
    public function update(Request $request,$module,$id)
    {
        ...
        try{
            ...
            if ($request->hasFile('profile_picture')) {
                ...
                //     'attachment', file_get_contents(public_path('uploads/user_no_image.png')), 'user_no_image.png'
                // )->post('https://app.shujog.xyz/api/thardparyservice/update-user-image', [
                //     'user_id' => 5273,
                // ]);
    ...
    public function commentView($module,$user_id)
    {
        ...
        return view("agent::stakeholders.comments.consultant",[
            'module'=>$module,
            'user_id'=>$user_id,
    ...
    public function consultantCommentSubmit(Request $request,$module,$user_id)
    {
        ...
        try{
            ...
            return redirect($module.'/stakeholders/consultant-comments/'.$user_id);
