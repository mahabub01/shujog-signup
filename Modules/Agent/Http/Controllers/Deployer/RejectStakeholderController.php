...
use Modules\Agent\Exports\Deployer\DeployerRejectAllStkExport;
use Modules\Agent\Exports\Deployer\DeployerRejectSelectableExport;
...
class RejectStakeholderController extends Controller
{
    ...
    public function index($module,Request $request)
    {
        ...
        return view("agent::deployers.stakeholders.reject.index",[
    ...
    public function allExport(Request $request,$module){
        ...
        return Excel::download(new DeployerRejectAllStkExport($request), time().'deployer-all-reject-stackholders.xlsx');
    }
    ...
    public function selectable(Request $request,$module){
        ...
        return Excel::download(new DeployerRejectSelectableExport($request), time().'_deployer_stakeholders.xlsx');
    ...
    public function commentView($module,$user_id)
    {
        ...
        return view("agent::deployers.stakeholders.comments.reject-comment",[
            'module'=>$module,
            'user_id'=>$user_id,
    ...
    public function consultantCommentSubmit(Request $request,$module,$user_id)
    {
        ...
        try{
            ...
            return redirect($module.'/dp-reject-comments/'.$user_id);
