...
class StkholderController extends Controller
{
    ...
    public function index($module,Request $request)
    {
        ...
        return view("agent::nmanagers.stakeholders.index",[
    ...
    public function allExport(Request $request,$module){
        ...
        return Excel::download(new NmanagerAllStakeholderExport($request), time().'all-stackholders.xlsx');
    }
    ...
    public function selectable(Request $request,$module){
        ...
        return Excel::download(new NmanagerSelectableExport($request), time().'_deployer_stakeholders.xlsx');
    }
    ...
    *********************************/
        ...
        return view("agent::nmanagers.stakeholders.details",[
            'user'=>$user,
            'module'=>$module,
    ...
    public function commentView($module,$user_id)
    {
        ...
        return view("agent::nmanagers.stakeholders.comments.comment",[
            'module'=>$module,
            'user_id'=>$user_id,
    ...
    public function consultantCommentSubmit(Request $request,$module,$user_id)
    {
        ...
        try{
            ...
            return redirect($module.'/nmg-stkholders/comments/'.$user_id);
